(() => {
  ...
  /* Beta v0.13.5 compatibility entry point.
  ...
  load('version.js', () => load('beta071-base.js', () => loadTheme(() => load('theme-toggle.js', () => load('mobile-overhaul-v133.js?v=0.13.5')))));
})();
